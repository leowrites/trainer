...
export function createGluestackColorConfig(
  ...
  return vars({
    ...
    '--color-success-500': formatColor(parseColor(tokens.accent)),
    '--color-success-600': mix(tokens.accent, black, 0.12),
    '--color-success-700': mix(tokens.accent, black, 0.24),
    ...
    '--color-background-success': formatColor(parseColor(tokens.accentSubtle)),
